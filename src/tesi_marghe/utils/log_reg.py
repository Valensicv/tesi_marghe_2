...
def calculate_roc_metrics(
    ...
    # Test di Mann-Whitney per H0: AUC = 0.5
    u_stat, p_two_sided = stats.mannwhitneyu(y, y_pred_proba, alternative='two-sided')
...
def plot_roc_analysis(
    ...
    # ROC Curve
    ax1.plot(roc_metrics['fpr'], roc_metrics['tpr'], 
             color='blue', lw=2, 
...
def run_complete_logistic_analysis(
    ...
    """
    Esegue l'analisi completa di regressione logistica.
    ...
    summary_results = pl.DataFrame({
        ...
        'Main_Predictor_OR': [odds_ratios[0]['Odds_Ratio']],
        'Main_Predictor_CI_Lower': [odds_ratios[0]['OR_CI_Lower']],
        'Main_Predictor_CI_Upper': [odds_ratios[0]['OR_CI_Upper']],
